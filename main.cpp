/*
Diego Alejandro Estrada Beltran
200427046
*/
...
//initial min and max  HSV filter vaues.
...
//FUNCTIONS
//Create a window for the Fine Tuninig
...
void createTrackBars()
{
	...
	//3 parametre are address variables that chages when the tracking is changed
...
int main() {
	...
	createTrackBars();//Calls and Creates the trackbar slider box
	...
	while (1)
	{
		...
		//Step 5 - us a vector to get HoughLinesP
